...
class About extends React.Component {
    private makeProgbar(datas: ProggressBarData[]): JSX.Element[] {
    ...
    private makeHistory(datas: History[]): JSX.Element[] {
        return datas.map((data) => {
                ...
                <div className="container">
                    ...
                    <div className="row skills-content">
                        <div className="col-lg-6" data-aos="fade-up">
                            ...
                            {this.makeProgbar(profile.skills)}
                        </div>
                        <div className="col-lg-6" data-aos="fade-up">
                            <h3 className="child-title">Languages</h3>
                            {this.makeProgbar(profile.languages)}
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-6" data-aos="fade-up">
                            <h3 className="child-title">Education</h3>
                            {this.makeHistory(profile.education)}
                        </div>
                        <div className="col-lg-6" data-aos="fade-up">
                            <h3 className="child-title">Work History</h3>
                            {this.makeHistory(profile.workHistory)}
                        </div>
                    </div>
                </div>
            </section>
